  ...
  <body class="g-sidenav-show bg-gray-100">
    ...
    >
      ...
      <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link {{$breadcrumb == 'Dashboard' ? 'active' : ''}}" href="{{route('dashboard')}}">
              <div
          ...
          <li class="nav-item">
            <a class="nav-link {{$breadcrumb == 'Hotel' ? 'active' : ''}}" href="{{route('hotel.list')}}">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
          ...
          <li class="nav-item">
            <a class="nav-link {{$breadcrumb == 'Room' ? 'active' : ''}}" href="{{route('room.list')}}">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
          ...
          <li class="nav-item">
            <a class="nav-link {{$breadcrumb == 'User' ? 'active' : ''}}" href="{{route('user.list')}}">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
          ...
          <li class="nav-item">
            <a class="nav-link {{$breadcrumb == 'Booking' ? 'active' : ''}}" href="{{route('booking.list')}}">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
