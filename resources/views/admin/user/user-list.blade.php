                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            @if (isset($item->image))
                              <img src="{{asset('uploads/users/'.$item->image)}}" class="avatar avatar-lg me-3" alt="user1">
                            @else
                              <img src="{{asset('uploads/users/default-avatar.png')}}" class="avatar avatar-lg me-3" alt="user1">
