...
<div id="create-form" style="display: none" class="card mb-4">
  ...
  <div class="form-group mt-4">
    ...
    <input type="text" name="name" class="form-control" id="inputName" aria-describedby="nameHelp" placeholder="Enter service name">
  </div>
...
<div class="card mb-4">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{asset('uploads')}}" class="avatar avatar-lg me-3" alt="user1">
                          </div>
        ...
        @else 
        <h2 class="my-4 mx-4">No service found</h2>
        @endif
<script>
 function create() {
