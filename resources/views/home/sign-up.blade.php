...
<head>
  ...
  <!--     Fonts and icons     -->
  <link href="{{asset('dashboard/css/login-font.css')}}" rel="stylesheet" />
  <!-- Nucleo Icons -->
  <link href="{{asset('dashboard/css/nucleo-icons.css" rel="stylesheet')}}" />
  <link href="{{asset('dashboard/css/nucleo-svg.css" rel="stylesheet')}}" />
  <!-- Font Awesome Icons -->
  <script src="dashboard/js/font-awesome-login.js" crossorigin="anonymous"></script>
  <link href="{{asset('dashboard/css/nucleo-svg.css" rel="stylesheet')}}" />
  <!-- CSS Files -->
  <link id="pagestyle" href="{{asset('dashboard/css/soft-ui-dashboard.css?v=1.0.5')}}" rel="stylesheet" />
</head>
...
<body class="">
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="post">
                    ...
                    <label>Name</label>
                    <div class="mb-3">
                      <input type="text" name="name" required class="form-control" placeholder="Name" aria-label="Name" aria-describedby="name-addon">
                    </div>
                    ...
                    <div class="mb-3">
                      <input type="password" name="repassword" required class="form-control" placeholder="Re-Password" aria-label="Password" aria-describedby="password-addon">
                    </div>
                     <label>Phone Number</label>
                    <div class="mb-3">
                      <input type="number" name="phone" required class="form-control" placeholder="Phone number" aria-label="Phone" aria-describedby="phone-addon">
                    </div>
                     <label>Identification Number / Passport <small style="opacity: 0.7"><i>Căn cước công dân</i></small></label>
                    <div class="mb-3">
                      <input type="number" name="cccd" class="form-control" placeholder="Identification" aria-label="cccd" aria-describedby="cccd-addon">
                    </div>
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" id="rememberMe" checked="">
                      <label class="form-check-label" for="rememberMe">Accept Policies</label>
                    </div>
      ...
      <div class="row">
        <div class="col-8 mx-auto text-center mt-1">
          <p class="mb-0 text-secondary">
            ...
            </script> Booking Hotel by Team 4
          </p>
        </div>
      </div>
    </div>
  ...
  <!-- Github buttons -->
  <script async defer src="dashboard/js/buttons.js"></script>
