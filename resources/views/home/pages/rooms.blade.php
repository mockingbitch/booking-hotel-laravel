		...
		<div class="search-grids">
			<div class="col-md-3 search-grid-left">
				<div class="search-hotel">
					...
					<form>
						<input type="text" value="Room name..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Room name...';}" required="">
			...
			<div class="col-md-9 search-grid-right">
				...
				<div class="hotel-rooms">
					<div class="hotel-left">
						<a href=""><span class="glyphicon glyphicon-bed" aria-hidden="true"></span>{{$room->name}}</a>
						<p>{{$room->description}}</p>
						<div class="hotel-left-grids">
							<div class="hotel-left-one">
								<a href="single.html"><img src="{{asset('uploads/rooms/'.$room->image)}}" alt="" /></a>
							</div>
							<div class="hotel-left-two">
								...
								<a href="single.html"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>{{$room->hotel->name}}</a>
								<p><strong>Hotel: </strong>{{$room->hotel->name}} <span> Number of Rooms: {{$room->allstock}}</span></p>
							</div>
					...
					<div class="hotel-right text-right">
						<h4>=></h4>
						<br/>
						<a href="{{route('booking.room.view', ['id' => $room->id])}}">Booking</a>
					</div>
					<div class="clearfix"></div>
				</div>
                @endforeach
